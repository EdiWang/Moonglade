...
namespace Moonglade.Web.Tests.Controllers
{
    ...
    public class SettingsControllerTests
    {
        ...
        public async Task General_Post()
        {
            ...
            _mockBlogAudit.Verify(p => p.AddAuditEntry(BlogEventType.Settings, BlogEventId.SettingsSavedGeneral, It.IsAny<string>()));
        }
        ...
        public async Task Content_Post()
        {
            ...
            _mockBlogAudit.Verify(p => p.AddAuditEntry(BlogEventType.Settings, BlogEventId.SettingsSavedContent, It.IsAny<string>()));
        }
        ...
        public async Task Notification_Post()
        {
            ...
            _mockBlogAudit.Verify(p => p.AddAuditEntry(BlogEventType.Settings, BlogEventId.SettingsSavedNotification, It.IsAny<string>()));
        }
        ...
        public async Task Subscription_Post()
        {
            ...
            _mockBlogAudit.Verify(p => p.AddAuditEntry(BlogEventType.Settings, BlogEventId.SettingsSavedSubscription, It.IsAny<string>()));
        }
        ...
        public async Task Watermark_Post()
        {
            ...
            _mockBlogAudit.Verify(p => p.AddAuditEntry(BlogEventType.Settings, BlogEventId.SettingsSavedWatermark, It.IsAny<string>()));
        }
        ...
        public async Task Advanced_Post()
        {
            ...
            _mockBlogAudit.Verify(p => p.AddAuditEntry(BlogEventType.Settings, BlogEventId.SettingsSavedAdvanced, It.IsAny<string>()));
        }
        ...
        public async Task CustomStyleSheet_Post_Enabled_EmptyCSS()
        {
            ...
            _mockBlogAudit.Verify(p => p.AddAuditEntry(BlogEventType.Settings, BlogEventId.SettingsSavedAdvanced, It.IsAny<string>()), Times.Never);
        }
