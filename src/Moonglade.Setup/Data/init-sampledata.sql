...
INSERT INTO Post(Id, Title, Slug, PostContent, CommentEnabled, CreateTimeUtc, ContentAbstract, IsPublished, IsSelected, ExposedToSiteMap, IsFeedIncluded, LastModifiedUtc, IsDeleted, PubDateUtc, ContentLanguageCode) 
VALUES (@NewPostId, 'Welcome to Moonglade', 'welcome-to-moonglade', @PostCotent, 1, GETDATE(), @PostCotent, 1, 0, 1, 1, NULL, 0, GETDATE(), 'en-us')
