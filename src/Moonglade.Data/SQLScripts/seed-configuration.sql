...
INSERT BlogConfiguration (Id, CfgKey, CfgValue, LastModifiedTimeUtc) VALUES (1, 'ContentSettings', '{"EnableComments":true,"RequireCommentReview":true,"EnableWordFilter":false,"PostListPageSize":10,"HotTagAmount":10,"DisharmonyWords":"fuck|shit","ShowCalloutSection":false}', GETDATE())
...
INSERT BlogConfiguration (Id, CfgKey, CfgValue, LastModifiedTimeUtc) VALUES (4, 'GeneralSettings', '{"OwnerName":"Admin","OwnerEmail":"admin@edi.wang","Description":"Moonglade Admin","ShortDescription":"Moonglade Admin","AvatarBase64":"","SiteTitle":"Moonglade","LogoText":"moonglade","MetaKeyword":"moonglade","MetaDescription":"Just another .NET blog system","Copyright":"[c] 2021","UserTimeZoneBaseUtcOffset":"08:00:00","TimeZoneId":"China Standard Time","AutoDarkLightTheme":true,"ThemeId":1}', GETDATE())
...
DELETE FROM HtmlPitch
INSERT HtmlPitch (Id, PitchKey, HtmlCode) VALUES (1, 'Sidebar', '');
INSERT HtmlPitch (Id, PitchKey, HtmlCode) VALUES (2, 'Footer', '');
INSERT HtmlPitch (Id, PitchKey, HtmlCode) VALUES (3, 'Callout', '');
INSERT HtmlPitch (Id, PitchKey, HtmlCode) VALUES (4, 'Comment', '');
