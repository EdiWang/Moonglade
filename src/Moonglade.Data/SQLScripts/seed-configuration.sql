...
INSERT BlogConfiguration (Id, CfgKey, CfgValue, LastModifiedTimeUtc) VALUES (1, 'ContentSettings', '{"EnableComments":true,"RequireCommentReview":true,"UseFriendlyNotFoundImage":true,"EnableWordFilter":false,"PostListPageSize":10,"HotTagAmount":10,"DisharmonyWords":"fuck|shit","ShowCalloutSection":false,"CalloutSectionHtmlPitch":""}', GETDATE())
