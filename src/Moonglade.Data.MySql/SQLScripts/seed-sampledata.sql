INSERT INTO Category(Id, DisplayName, Note, RouteName) VALUES (UUID(), 'Default', 'Default Category', 'default');
...
VALUES (@NewPostId, 'Welcome to Moonglade', 'welcome-to-moonglade', 'admin', @PostCotent, 1, '2021-1-1', @PostCotent, 1, 0, 1, NULL, 0, NOW(), 'en-us', -1688639577, 1);
