...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `rust` grammar compiled for Highlight.js 11.3.1 */
...
relevance:0}]}}})();hljs.registerLanguage("objectivec",e)})();/*! `fsharp` grammar compiled for Highlight.js 11.3.1 */
...
end:/"/},f]},c,l,f,o]}}})();hljs.registerLanguage("fsharp",e)})();/*! `bash` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("powershell",e)})();/*! `json` grammar compiled for Highlight.js 11.3.1 */
